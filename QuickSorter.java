...
public abstract class QuickSorter implements Sorter
{
    ...
    private <T extends Comparable<T>> int partition(T[] a, int fst, int lst) {
        T pivot = a[pivotLocation(a, fst, lst)];
        int u = fst;
        int d = lst;
        do {
    ...
    private <T extends Comparable<T>> int partition(T[] a, int fst, int lst, Comparator<T> c) {
        T pivot = a[pivotLocation(a, fst, lst, c)];
        int u = fst;
        int d = lst;
        do {
     ...
     */
    public abstract int pivotLocation(int[] a, int fst, int lst);
     ...
     * @return  either first; median of first, middle and last; or a random element, depending on inheritance
     */
    public abstract <T extends Comparable<T>> int pivotLocation(T[] a, int fst, int lst);
     ...
     * @return  either first; median of first, middle and last; or a random element, depending on inheritance
     */
    public abstract <T extends Comparable<T>> int pivotLocation(T[] a, int fst, int lst, Comparator<T> c);
}
